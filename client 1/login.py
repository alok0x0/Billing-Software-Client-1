...
class Login_System:
    def __init__(self,root):
        ...
        txt_user=Entry(login_frame,textvariable=self.employee_id,font=("times new roman",15),bg="#ECECEC").place(x=50,y=140,width=250)
        ...
        #lbl_reg=Label(register_frame,text="Dont have an account ?",font=("times new roman",13),bg="white").place(x=40,y=20)
        #btn_signup= Button(register_frame, text="Sign Up", font=("times new roman", 13,"bold"), bg="white",
                            #fg="#00759E", bd=0, activebackground="white", activeforeground="#00759E").place(x=200,y=17)
    ...
    def login(self):
        ...
        #elif self.username.get()!="kodeosoft" or self.password.get()!="123456":
