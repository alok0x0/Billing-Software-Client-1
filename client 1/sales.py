...
class salesClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text="Local Bill",command=self.localbill,font=("times new roman",15,"bold"),bg="#2196f3",fg="white",cursor="hand2").place(x=620,y=100,width=120,height=28)
...
#==================================================================================================
    ...
    def localbill(self):
        ...
        self.new_obj=localClass(self.new_win)
