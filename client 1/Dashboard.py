...
class IMS:
    def __init__(self, root):
        ...
        btn_web = Button(self.root, text="Website",image=self.webbtn,command=self.web ,font=("times new roman", 15, "bold"),border=0,bg="#010c48"
                            ,cursor="hand2").place(x=1190, y=10, height=50, width=50)
        # ====Clock=====
        ...
        self.lbl_sales=Label(self.root,text="[ 0]",compound=TOP,border=0,image=self.box4,relief=RIDGE,font=("goudy old style",20,"bold"))
